...
export const SELECT_TODO_SUCCESS = '[Todo] Select Success';
...
export class SelectTodoSuccess implements Action {
  readonly type = SELECT_TODO_SUCCESS;
}
...
export type All = AddTodo | AddTodoSuccess | EditTodo | EditTodoSuccess | SelectTodo | SelectTodoSuccess | DeleteTodo | DeleteTodoSuccess | LoadTodos | LoadTodosFail | LoadTodosSuccess | ToggleTodo | ToggleTodoSuccess;
